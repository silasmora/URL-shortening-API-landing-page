...
const ShortenLink = (props: Props) => {
  return (
    <div className='flex flex-col gap-4 p-6 mx-6 bg-oldHeliotrope rounded-[10px] absolute -top-[80px] left-0 right-0 lg:px-[64px] lg:py-[52px] lg:flex-row lg:gap-6 lg:mx-[165px]'>
