...
const Header = () => {
  ...
  return (
    <>
      <div className='border-2 pt-10 pb-6 px-6 flex justify-between items-center lg:px-[165px] max-w-[1440px] mx-auto'>
      <div className='flex items-center lg:gap-11'>
      ...
      {isModalOpen&& <MobileMenuModal isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen}/>}
    </>
  )
}
