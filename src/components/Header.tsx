...
const Header = () => {
  ...
  const handleOutsideClick = (e: MouseEvent) => {
    ...
    if (closeButtonRef.current && closeButtonRef.current.contains(e.target as Node)) {
      return; // Do nothing if clicking the close button
    }
  ...
  return (
    <>
      <div className='pt-10 pb-6 px-6 flex justify-between items-center border lg:pt-12 lg:pb-[78px] lg:px-0'>
